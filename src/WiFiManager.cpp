...
<body>
    <div class="container">
        ...
        <div class="subtitle">Real-time Gas Monitoring System</div>
        ...
        <div style="margin: 20px auto; max-width: 600px; padding: 15px; background: #f5f5f5; border-radius: 8px;">
            <div style="font-weight: bold; margin-bottom: 10px; color: #333;">📡 Host Output Format (8Hz @ 115200 baud)</div>
            <div style="display: flex; gap: 15px; align-items: center;">
                <label style="flex: 1; cursor: pointer; padding: 10px; background: white; border: 2px solid #ddd; border-radius: 5px;">
